...
export function Sidebar({
  ...
  return (
    <nav
      className={`flex h-full flex-col gap-1 border-r border-neutral-200 bg-white px-3 pb-3 pt-[max(0.75rem,env(safe-area-inset-top))] transition-[width] duration-150 ${
        collapsed ? "w-16" : "w-60"
      }`}
    >
