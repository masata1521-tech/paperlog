...
export default async function PapersPage({
  ...
  return (
    <div className="mx-auto max-w-6xl p-8">
      ...
      {(tag || favorite === "1") && (
        <div className="mt-4 flex items-center gap-2 rounded-md bg-indigo-50 px-3 py-2 text-sm text-indigo-700">
          <span>
            {tag && `タグ「${tag}」で絞り込み中`}
      ...
      <form method="GET" className="mt-6 space-y-3">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-xl border border-neutral-300 py-3.5 pl-12 pr-4 text-base shadow-sm focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-100"
          />
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <input
            ...
            className="w-48 rounded-md border border-neutral-300 px-3 py-2 text-sm text-neutral-700 placeholder:text-neutral-400"
          />
          ...
          <button
            type="submit"
            className="ml-auto rounded-md bg-neutral-900 px-4 py-2 text-sm font-medium text-white hover:bg-neutral-800"
          >
            絞り込む
          </button>
        </div>
