  ...
  return (
    <div className="mx-auto max-w-4xl p-4 sm:p-8">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">研究プロジェクト</h1>
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
          {projects.map((project) => (
            <Link
              ...
              className="rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-5 shadow-sm transition-shadow hover:shadow-md"
            >
              <div className="flex items-center gap-2 text-neutral-400 dark:text-neutral-500">
                <FlaskConical size={16} />
                <span className="text-xs font-medium">{project._count.papers}件の論文</span>
              </div>
              <h2 className="mt-2 text-base font-bold text-neutral-900 dark:text-neutral-100">{project.title}</h2>
              {project.description && (
